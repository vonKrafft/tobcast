...
import easysim.util.StringListParser;
 ...
 * {@link easysim.util.StringListParser}. </LI>
 * </UL>
...
public static void doExperiments(Properties properties, String[] args)
{
	...
	while (idx[0] < values[0].length) {
		...
		//long seed = new ExtendedRandom(0123456).nextLong();
		//list.set(startseed, Simulator.PAR_SEED+"="+seed);
